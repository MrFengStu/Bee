	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a href="${ctx }/companylist.html">教员列表</a></li>
    			<li><a target="_blank" href="${ctx }/">职位列表</a></li>
       ...
       <c:forEach items="${invitationmap }" var="ms" >
           <li>
              <div class="d_item">
	               ...
	               <a class="btn_showprogress" href="${ctx }/Invitation/delete?InId=${ms.key.inId}">删除</a>
				</li>
				</c:forEach>
              </ul>
