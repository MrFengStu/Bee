            	...
            	<dl class="c_delivery">
                    ...
                    <dd>
                    	<div class="delivery_tabs">
                    		<ul class="reset">
                    			<li class="current">
                    				<a href="${ctx }/Delivery/Init">全部</a>
                    			</li>
                    			<li>
                    				<a href="${ctx }/Delivery/a">投递成功</a>
                    			</li>
                    			<li>
                    				<a href="${ctx }/Delivery/b">被查看</a>
                    			</li>
                    			<li>
                    				<a href="${ctx }/Delivery/c">通过初筛</a>
                    			</li>
                    			<li>
                    				<a href="${ctx }/Delivery/d">通知面试</a>
                    			</li>
                    			<li class="last">
                    				<a href="${ctx }/Delivery/e">不合适</a>
                    			</li>
                    		</ul>
                    	</div>
                            ...
                            <c:forEach items="${map }" var="ms" >
                               	 <li>
                             		<div class="d_item">
	                                    ...
	                                    <span class="d_time">${ms.value.reTime}</span>
	                                    <div class="clear"></div>
	                                    <div class="d_resume">
	                                    	使用简历：
	                                    	<span>在线简历</span>
	                                    </div>
	                                   <a class="btn_showprogress" href="${ctx }/Delivery/delete?DeId=${ms.key.deId}">删除</a>
                               		</div>
                               		</li>
                               	</c:forEach>
                            </ul>
