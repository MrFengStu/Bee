...
<title>我收藏的职位-招聘服务-蜜蜂网-最专业的互联网家教平台</title>
        	...
        	<dl class="collapsible_menu">
            	<dt>
            		...
            		<i></i>
                   	...
                   	<dd><a rel="nofollow" href="${ctx }/jianli.jsp">我的简历</a></dd>
                	<dd><a href="${ctx }/collections.jsp">我收藏的职位</a></dd>
                	<dd class="btm"><a href="${ctx }/subscribe.jsp">我的订阅</a></dd>
                	<dd><a href="${ctx }/create.jsp">我要招人</a></dd>
                    <dd><a href="${ctx }/accountBind.jsp">帐号设置</a></dd>
                    <dd class="logout"><a rel="nofollow" href="${ctx }/login.jsp">退出</a></dd>
            </dl>
