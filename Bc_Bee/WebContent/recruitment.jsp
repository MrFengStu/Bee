    ...
    <div id="container">
            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	<div class="ccc_tr">今日已发布 <span>${sum}</span> 条信息   还可发布 <span>${last}</span> 条信息</div>
                    	<form action="${ctx}/publish/add" method="post" id="jobForm">
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">招聘题目</td>
                                	<td>
                                    	<input type="text" id="jobTitle" value="${jobTitle}" name="jobTitle">
                                       </td>
                                       <td style="height:30px;padding:0px;font-size:14px;" class="redstar"> 
			                                <c:if test="${sessionScope.jobTitleError != null}">
												 ${sessionScope.jobTitleError} 
												<br>
											</c:if>	
									   </td> 
                                </tr>
                            	<tr>
                                	...
                                	<td>联系人</td>
                                	<td>
                                    	<input type="text" placeholder="" value="${contacts}" name="contacts" id="contacts">
                                    	                                    </td>
                                    	                                    <td style="height:30px;padding:0px;font-size:14px;" class="redstar"> 
			                                <c:if test="${sessionScope.contactsError != null}">
												 ${sessionScope.contactsError} 
												<br>
											</c:if>	
									   </td>
                                </tr>
                            	<tr>
                                	...
                                	<td>联系方式</td>
                                	<td>
                                    	<input type="text" placeholder="" value="${contactInfo}" name="contactInfo" id="contactInfo">	
                                    </td>
                                    <td style="height:30px;padding:0px;font-size:14px;" class="redstar"> 
			                                <c:if test="${sessionScope.contactInfoError != null}">
												 ${sessionScope.contactInfoError} 
												<br>
											</c:if>	
									   </td>
                                </tr>
                            ...
                            <table class="btm">
                            	...
                            	<tr>
                                	...
                                	<td>
                                    	<div class="salary_range">
                                            <div>
                                                <input type="text" placeholder="" value="石家庄" id="shi" name="shi"> 
                                                <span>市</span>
                                            </div>
                                            <!--  
                                            <div>
                                                <input type="text" placeholder="" value="${qu}" id="qu" name="qu"> 
                                                <span>区</span>
                                            </div>-->
                                            <div>
                                                <select style="width:150px;height:40px; font-size:14px; font-style:"微软雅黑";color:#777;" name="qu" value="${qu}">  
                                    ...
                                    <td style="height:30px;padding:0px;font-size:14px;" class="redstar"> 
			                                <c:if test="${sessionScope.ShiQuError != null}">
												 ${sessionScope.ShiQuError} 
												<br>
											</c:if>	
									   </td>
                                </tr>
                            	...
                            	<tr>
                                	...
                                	<td>详细地址</td>
                                	<td>
                                    	<input type="text" placeholder="" value="${address}" name="address" id="address">
                                    </td>
                                    <td style="height:30px;padding:0px;font-size:14px;" class="redstar"> 
			                                <c:if test="${sessionScope.addressError != null}">
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">授课科目</td>
                                	<td>
                                    	<input type="text" id="subject" value="${subject}" name="subject">
                               ...
                               <!--新加内容  -->
							    ...
							    <tr>
                                	...
                                	<table style="text-align:center;margin-top:-30px;margin-left:60px;font-size:14px; width:500px;"> 
                                    	...
                                    	<tr>
                                    		<td  >上午</td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期一上午" id="time"/></td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期二上午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期三上午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期四上午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期五上午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期六上午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期日上午" id="time"/> </td>
                                    	</tr>
                                    	<tr>
                                    		<td  >下午</td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期一下午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期二下午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期三下午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期四下午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期五下午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期六下午" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期日下午" id="time"/> </td>
                                    	</tr>

                                    	<tr>
                                    		<td  >晚上</td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期一晚上" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期二晚上" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期三晚上" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期四晚上" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期五晚上" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期六晚上" id="time"/> </td>
                                    		<td  ><input name="WTime" type="checkbox" value="星期日晚上" id="time"/> </td>
                               ...
                               <!--新加内容  -->
                            	<tr>
                                	...
                                	<!--  
                                	<td>
                                    	<input type="text" placeholder="如：50元/小时" id="salary" value="${salary}" name="salary">
                                      
                                    </td>-->
                                    <td>
                                    	<select style="width:180px;height:40px; font-size:14px; font-style:"微软雅黑";color:#777;" name="salary">  
  											<option value ="30元以下">30元以下</option>  
  											<option value ="30元-50元">30元-50元</option>  
  											<option value="50元-100元">50元-100元</option>  
  											<option value="100元以上">100元以上</option>  
										</select>  

                                    </td>
                                    <td style="height:30px;padding:0px;font-size:14px;" class="redstar"> 
			                                <c:if test="${sessionScope.salaryError != null}">
												 ${sessionScope.salaryError} 
												<br>
											</c:if>	
									   </td>
                                </tr>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td style="width:30px; color:red;font-size:14px;">
                                    	<input style="margin-right:35px;" type="text" placeholder="如：周结、月结等" value="" name="settle" class="input_520" id="settle">
                                    	<c:if test="${sessionScope.subjectError != null}">
												 ${sessionScope.subjectError} 
                            	...
                            	<tr>
                                	...
                                	<td>学生情况</td>
                                	<td>
                                    	<span class="c9 f14">(建议分条列举学生(您孩子)的一些情况)</span>
                                    	
                                        <textarea id="stuInfo" name="stuInfo" class="form-control kindeditorSimple" style="height:150px;"></textarea>
                            ...
                            <table>
                                ...
                                <tr>
                                	...
                                	<td colspan="2">
                                    		...
                                    		<input type="submit" formaction="${ctx}/publish/preview" value="预览" id="jobPreview" class="btn_32">
...
<div style="display:none;">
    ...
    <!--地图弹窗-->	
        <div class="popup" id="baiduMap">
        	<div class="mb10">点击地图可重新定位工作所在的位置</div>
