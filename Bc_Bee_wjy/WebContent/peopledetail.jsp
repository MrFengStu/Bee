    ...
    <div id="container">
            ...
            <c:forEach items="${resume }" var="rm">
                    ...
                    <dd class="job_request">
                    	<span class="red">${rm.tsalary}</span>
                    ...
                    <dd class="job_bt">
                        ...
                        <p>工作信息： <br />1、优惠信息：${rm.discount}； <br />2、期望薪资：${rm.tsalary}； <br />3、授课科目：${rm.SGrade};<br/>4、授课方式：${rm.teaMode};<br/>5、授课区域：${rm.area};<br/>6、授课时间:${rm.ttime};</p>
