...
<script async="" src="${ctx }/style/js/analytics.js"></script><script type="text/javascript" async="" src="style/js/conversion.js"></script><script src="style/js/allmobilize.min.js" charset="utf-8" id="allmobilize"></script><style type="text/css"></style>
...
<script type="text/javascript" src="${ctx }/style/js/jquery-hbzx.js"></script>
<!--[if lte IE 8]>
	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a target="_blank" href="toForum.html">职位列表</a></li>
                    ...
                    <dd class="job_bt">
						...
						<p>${rf1.subsidy}</p>
                      	...
                      	<div class="dropdown_menu">
							<div class="drop_l">
								<img width="131" height="131" src="${ctx }/style/images/73338ca8e1694b298d223745670f8daf_318969.jpg">
																<span>[仅限本人使用]</span>
															</div>
							<div class="drop_r">
...
<!-- 投递简历时  - 设置默认投递简历 -->
	...
	<div style="height:240px;" class="popup" id="loginPop">
       	<form id="loginForm">
			<input type="text" placeholder="请输入登录邮箱地址" tabindex="1" name="email" id="email" style="background-image: url(${ctx }/style/images/img/0CQnd2Jos49xUAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;">
			<input type="password" placeholder="请输入密码" tabindex="2" name="password" id="password" style="background-image: url(${ctx }/style/images/img/0CQnd2Jos49xUAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;">
		    ...
		    <a class="fr" href="reset.html">忘记密码？</a>
		...
		<div class="login_right">
		    ...
		    <a title="使用新浪微博帐号登录" class="icon_wb" target="_blank" href="ologin/auth/sina.html"></a>
		    <a title="使用腾讯QQ帐号登录" target="_blank" class="icon_qq" href="ologin/auth/qq.html"></a>
		</div>
    </div><!--/#loginPop-->
        ...
        <table width="100%">
            <tbody><tr class="drawGGJ">
                <td align="center">
                	...
                	<p class="font_16 share dn">邀请好友成功注册拉勾，可提升每日投递量 &nbsp;&nbsp; <a target="_blank" href="share/invite.html">邀请好友&gt;&gt;</a></p>
                </td>
            </tr>
        	<tr class="drawQD">
            	<td align="center"><a class="btn_s" href="javascript:top.location.reload();">确&nbsp;定</a></td>
            ...
            <tr class="weixinQR">
            	<td>
            		<div class="weixin">
                       	<div class="qr">
                       		<img width="120" height="120" src="${ctx }/style/images/73338ca8e1694b298d223745670f8daf_318969.jpg">
	    	...
	    	<tr>
	        	<td align="center">
                   <form>
                    ...
                    <a target="_blank" href="resume/basic.html" class="btn">完善在线简历</a>
	            </td>
	        </tr>
	    </tbody></table>
	</div><!--/#sendNoResume-->
...
<script src="${ctx }/style/js/tongji.js" type="text/javascript"></script>
<!--  -->
<script src="${ctx }/style/js/analytics01.js" type="text/javascript"></script><script type="text/javascript" src="style/js/h.js"></script>
<script type="text/javascript">
$(function(){
	$('#noticeDot-1').hide();
