	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul class="reset" id="navheader">
    			...
    			<li ><a href="#" target="_blank">职位列表</a></li>
            	...
            	<a href="javascript:;">我知道了</a>
            	            ...
            	            <c:forEach items="${recinfo }" var="rf">
	                    		                    			                <li class="odd clearfix">
			                			                				                	<div class="hot_pos_l">
			                        <div class="mb10">
			                            <a href="h/jobs/86989.html" title="前端开发" target="_blank">${rf.jobTitle }</a> 
			                            &nbsp;
						        ...
						        <div class="hot_pos_r">
			                        ...
			                        <!--<ul class="companyTags reset">
	                    		         ...
	                    		         <!--        			                <li class="odd clearfix">
			                			                				                	<div class="hot_pos_l">
			                        <div class="mb10">
			                            <a href="h/jobs/86989.html" title="前端开发" target="_blank">数学</a> 
			                            &nbsp;
			                            <span class="c9">[裕华区]</span>
			                            			                        </div>
			                        <span><em class="c7">时薪：</em>30元-50元</span>
			                        <span><em class="c7">经验：</em> 1年</span>
			                        <span><em class="c7">最低学历： </em>本科</span>
			                        <br />
			                        <span><em class="c7">职位诱惑：</em>“午饭&nbsp&nbsp滴滴打车”</span>
			                        <br />
			                        <span>1天前发布</span>
			                    </div> 
						        <div class="hot_pos_r">
			                        ...
			                        <div class="mb10"><a href="h/c/1712.html" title="紫色医疗" target="_blank">家长A</a></div>
